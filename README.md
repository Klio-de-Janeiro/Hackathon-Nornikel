...
Зависимости поддерживают Python 3.12–3.14. Для воспроизводимости рекомендуется выбрать Python 3.12 в **Advanced settings** при создании приложения. Версию Python уже созданного приложения можно изменить только удалением и повторным развёртыванием.
